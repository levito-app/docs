...
The Services, known as [Levito.app](http://Levito.app) (the "Service"), is owned and operated by [**levito.app**](http://levito.app)
...
The Service provides a platform that facilitates **leveraged cryptocurrency trading** and the provision of **First-Loss Margin Secured Funding Capital** for professional trading strategies. The Service is not a bank, financial institution, or licensed financial advisor, rather, it is a technology provider.
...
a) The Service operates **temporary custodial wallets** for receiving and sending user funds. These wallets are used solely for the duration necessary to execute a transaction or operation. b) **You retain beneficial ownership of your funds (_Transfer initiated by you from your cold wallet or exchange account_)** **held in the temporary custodial wallets until that amount is transferred to your **[**levito.app**](http://levito.app)** account.** c) The Service is not responsible for losses due to network congestion, blockchain forks, or smart contract vulnerabilities.
